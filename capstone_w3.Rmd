...
- re-do the data cleaning steps and
	- exclude stopword removal
	- improve ' removal (don't, doesn't etc are weird in the current sets
	- apply tolower (wasn't properly applied)
